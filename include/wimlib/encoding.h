                         ...
                         size_t *out_nbytes_ret)
{
	...
	*out_ret = in;
	...
	return 0;
#else
	return tstr_to_utf16le(
		in, in_nbytes, (utf16lechar **)out_ret, out_nbytes_ret);
#endif
}
 ...
 * when done.  */
static inline int
utf16le_get_tstr(const utf16lechar *in,
                 size_t in_nbytes,
                 const tchar **out_ret,
                 size_t *out_nbytes_ret)
{
	...
	*out_ret = in;
	...
	return utf16le_to_tstr(
		in, in_nbytes, (tchar **)out_ret, out_nbytes_ret);
#endif
}
