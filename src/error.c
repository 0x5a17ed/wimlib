...
wimlib_vmsg(const tchar *tag, const tchar *format, va_list va, bool perror)
{
	...
	if (perror && errno_save != 0) {
		...
		if (res) {
			tsprintf(
				buf, T("unknown error (errno=%d)"), errno_save);
		}
#ifdef _WIN32
		if (errno_save == EBUSY)
...
static const tchar *const error_strings[] = {
	...
	[WIMLIB_ERR_INVALID_CAPTURE_CONFIG] = T(
	...
	[WIMLIB_ERR_INVALID_HEADER] = T("The WIM header was invalid"),
	...
	[WIMLIB_ERR_INVALID_PARAM] = T("An invalid parameter was given"),
	[WIMLIB_ERR_INVALID_PART_NUMBER] =
		T("The part number or total parts of the WIM is invalid"),
	[WIMLIB_ERR_INVALID_PIPABLE_WIM] = T("The pipable WIM is invalid"),
	[WIMLIB_ERR_INVALID_REPARSE_DATA] =
		T("The reparse data of a reparse point was invalid"),
	[WIMLIB_ERR_INVALID_RESOURCE_HASH] = T(
	...
	[WIMLIB_ERR_LINK] =
		T("Failed to create a hard or symbolic link when extracting "
	          "a file from the WIM"),
	[WIMLIB_ERR_METADATA_NOT_FOUND] = T(
		"The WIM does not contain image metadata; it only contains file data"),
	[WIMLIB_ERR_MKDIR] = T("Failed to create a directory"),
	[WIMLIB_ERR_MQUEUE] =
		T("Failed to create or use a POSIX message queue"),
	[WIMLIB_ERR_NOMEM]    = T("Ran out of memory"),
	[WIMLIB_ERR_NOTDIR]   = T("Expected a directory"),
	[WIMLIB_ERR_NOTEMPTY] = T("Directory was not empty"),
	...
	[WIMLIB_ERR_NOT_PIPABLE] =
		T("The WIM was not captured such that it can be "
	          "applied from a pipe"),
	[WIMLIB_ERR_NTFS_3G] = T("NTFS-3G encountered an error (check errno)"),
	[WIMLIB_ERR_OPEN]    = T("Failed to open a file"),
	[WIMLIB_ERR_OPENDIR] = T("Failed to open a directory"),
	[WIMLIB_ERR_PATH_DOES_NOT_EXIST] =
		T("The path does not exist in the WIM image"),
	[WIMLIB_ERR_READ] = T("Could not read data from a file"),
	[WIMLIB_ERR_READLINK] =
		T("Could not read the target of a symbolic link"),
	[WIMLIB_ERR_RENAME] = T("Could not rename a file"),
	[WIMLIB_ERR_REPARSE_POINT_FIXUP_FAILED] =
		T("Unable to complete reparse point fixup"),
	[WIMLIB_ERR_RESOURCE_NOT_FOUND] = T(
		"A file resource needed to complete the operation was missing from the WIM"),
	[WIMLIB_ERR_RESOURCE_ORDER] = T(
	...
	[WIMLIB_ERR_UNICODE_STRING_NOT_REPRESENTABLE] = T(
	...
	[WIMLIB_ERR_UNSUPPORTED] = T("The requested operation is unsupported"),
	[WIMLIB_ERR_UNSUPPORTED_FILE] = T(
		"A file in the directory tree to archive was not of a supported type"),
	[WIMLIB_ERR_WIM_IS_READONLY] = T(
		"The WIM is read-only (file permissions, header flag, or split WIM)"),
	[WIMLIB_ERR_WRITE] = T("Failed to write data to a file"),
	[WIMLIB_ERR_XML]   = T("The XML data of the WIM is invalid"),
	[WIMLIB_ERR_WIM_IS_ENCRYPTED] =
		T("The WIM file (or parts of it) is encrypted"),
	[WIMLIB_ERR_WIMBOOT] = T("Failed to set WIMBoot pointer data"),
	[WIMLIB_ERR_ABORTED_BY_PROGRESS] =
		T("The operation was aborted by the library user"),
	[WIMLIB_ERR_UNKNOWN_PROGRESS_STATUS] = T(
	...
	[WIMLIB_ERR_NOT_PERMITTED_TO_UNMOUNT] = T(
	...
	[WIMLIB_ERR_WIM_IS_INCOMPLETE] = T("The WIM file is incomplete"),
	...
	[WIMLIB_ERR_DUPLICATE_EXPORTED_IMAGE] = T(
		"The destination WIM already contains one of the source images"),
	[WIMLIB_ERR_CONCURRENT_MODIFICATION_DETECTED] = T(
	...
	[WIMLIB_ERR_IMAGES_ARE_DIFFERENT] = T(
		"A difference was detected between the two images being compared"),
#endif
};
